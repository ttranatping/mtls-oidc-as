...
public class MASSLClient {
	...
	public static HttpResponseObj executeGETHTTP(String url, 
			Map<String, String> headers, String [] httpsProtocolSupport,
			boolean ignoreSSLErrors, int requestTimeout) throws Exception {
		
		return executeHTTP(url, "GET", headers, null, httpsProtocolSupport, null, ignoreSSLErrors, requestTimeout);
	}
	...
	public static HttpResponseObj executeHTTP(String url, String method,
		...
		return executeHTTP(url, method, headers, entity, httpsProtocolSupport, null, ignoreSSLErrors, requestTimeout);
	}
	...
	public static HttpResponseObj executeHTTP(String url, String method,
			Map<String, String> headers, StringEntity stringEntity, String [] httpsProtocolSupport,
